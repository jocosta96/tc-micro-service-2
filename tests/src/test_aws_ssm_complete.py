...
def test_get_parameter_not_found(mock_boto_client):
    ...
    mock_boto_client.get_parameter.side_effect = ClientError(error_response, 'get_parameter')
...
def test_get_parameter_connection_error(mock_boto_client):
    ...
    mock_boto_client.get_parameter.side_effect = EndpointConnectionError(endpoint_url='https://ssm.us-east-1.amazonaws.com')
...
def test_get_parameters_connection_error(mock_boto_client):
    ...
    mock_boto_client.get_parameters.side_effect = EndpointConnectionError(endpoint_url='https://ssm.us-east-1.amazonaws.com')
