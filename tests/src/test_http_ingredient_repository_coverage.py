...
class TestHTTPIngredientRepository:
    ...
    def test_find_by_id_success(self, mock_get):
        ...
        mock_get.return_value.json.return_value = {'name': 'Tomato', 'price': {'amount': 1.0}, 'is_active': True, 'type': 'vegetable', 'applies_to_burger': True, 'applies_to_side': False, 'applies_to_drink': False, 'applies_to_dessert': False}
